...
var Switch = function (_React$Component) {
  ...
  _createClass(Switch, [{
    ...
    value: function switchStyles() {
      ...
      return (0, _utils.merge)({ borderRadius: switchStyles.width / 2 }, switchStyles, this.switchBackgroundStyle(), {
    ...
    value: function switchBackgroundStyle() {
      var switchStyles = this.switchStylesProps();
      var backgroundColor = this.state.value ? switchStyles.onColor : switchStyles.offColor;
      var borderColor = this.state.value ? switchStyles.onColor : switchStyles.offColor;
